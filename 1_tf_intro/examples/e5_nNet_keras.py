...
model.add( layers.Conv2D(filters=32, kernel_size= 5, strides=1,padding='same', activation='relu',  input_shape= x_train.shape[1:] ))
...
print("Testing evaluation loss %f acc %f roc_auc %f"%score)
